  ...
  return ( 
    <View style={{ flex: 1 , flexDirection: 'column', justifyContent:'space-around'}}>
      <View style={{ position: 'absolute', top: 0, right: 0, zIndex: 10,}}>
        <ShoppingCart items={cartItems} theme="dark" showItems={true} size="large"/>
      </View>      
      <Carousel data={storeItems} onItemPress={addToCart} theme="light" itemsPerRow={3} scrollBehaviour="scroll" />
